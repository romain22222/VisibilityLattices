...
% Title
    ...
    \begin{frame}{Our Objective}
        \fbox{%
            \begin{minipage}{\linewidth}
                Geometric analysis of digitized shapes of both smooth and piecewise-smooth surfaces.
            \end{minipage}%
        }
    ...
    \begin{frame}{Visibility set may be non-connex}
        \begin{itemize}
            \item The set of digitized points visible from a given surface point is not necessarily connected.
    ...
    \begin{frame}{Representing the star of a shape}
        ...
        \begin{tikzpicture}[scale=0.75]
            ...
            \draw decorate [decoration={crosses,transform={rotate=45},shape size=1.5mm,segment length=21.5pt}] {(-1,0) -- (6,0)};
    ...
    \begin{frame}{Representing the star of a shape}
        ...
        \begin{tikzpicture}[scale=0.75]
            ...
            \filldraw[black] (4,2) circle (0.05);
            \draw[-{Stealth[length=3mm]}=black] (-1,0) -- (-1,7);
            \draw decorate [decoration={crosses,transform={rotate=45},shape size=1.5mm,segment length=10.75pt}] {(-1,1) -- (-1,7)};
            \foreach \y in {0,0.5,...,5} {
                \node at (-1.5,\y+1) {\y};
            }

            \draw[-{Stealth[length=3mm]}=black] (-1,0) -- (6.5,0);
            \draw decorate [decoration={crosses,transform={rotate=45},shape size=1.5mm,segment length=10.75pt}] {(-1,0) -- (6,0)};
            \foreach \x in {0,1,...,5} {
                \node at (\x,-0.5) {\x};
            }
    ...
    \newcommand{\drawInterval}[4]{
        \draw[thin,#4, arrows = {Bracket[sharp]-Bracket[sharp]}] (#1-0.1,#2)--(#3+0.1,#2);
    }
    \begin{frame}{Computing the visibility}
        \begin{tabular}{c c}
            \begin{tikzpicture}[scale=0.4]
                \draw[step=0.5,lightgray,thin,xshift=-1cm,yshift=-1cm] (-0.75,-0.75) grid (14.25,14.25);
                \draw[black] (0,1) -- (4,1) -- (4,0) -- (7,0) -- (7,1) -- (10,1) -- (10,2) -- (11,2) -- (11,5) -- (10,5) -- (10,6) -- (9,6) -- (9,7) -- (7,7) -- (7,9) -- (9,9) -- (9,10) -- (10,10) -- (10,11);
                \draw[thick,dashed] (-1,0) -- (3,0) -- (3,-1) -- (8,-1) -- (8,0) -- (11,0) -- (11,1) -- (12,1) -- (12,6) -- (11,6) -- (11,7) -- (10,7) -- (10,8) -- (8,8) -- (10,8) -- (10,9) -- (11,9) -- (11,12) -- (9,12) -- (9,11) -- (8,11) -- (8,10) -- (6,10) -- (6,6) -- (8,6) -- (8,5) -- (9,5) -- (9,4) -- (10,4) -- (10,3) -- (9,3) -- (9,2) -- (6,2) -- (6,1) -- (5,1) -- (5,2) -- (-1,2) -- (-1,0);

                \drawBlackPointPoint{0}{1};
                \drawBlackPointPoint{1}{1};
                \drawBlackPointPoint{2}{1};
                \drawBlackPointPoint{3}{1};
                \drawBlackPointPoint{4}{1};
                \drawBlackPointPoint{4}{0};
                \drawBlackPointPoint{5}{0};
                \drawBlackPointPoint{6}{0};
                \drawBlackPointPoint{7}{0};
                \drawBlackPointPoint{7}{1};
                \drawBlackPointPoint{8}{1};
                \drawBlackPointPoint{9}{1};
                \drawBlackPointPoint{10}{1};
                \drawBlackPointPoint{10}{2};
                \drawBlackPointPoint{11}{2};
                \drawBlackPointPoint{11}{3};
                \drawBlackPointPoint{11}{4};
                \drawBlackPointPoint{11}{5};
                \drawBlackPointPoint{10}{5};
                \drawBlackPointPoint{10}{6};
                \drawBlackPointPoint{9}{6};
                \drawBlackPointPoint{9}{7};
                \drawBlackPointPoint{8}{7};
                \drawBlackPointPoint{7}{7};
                \drawBlackPointPoint{7}{8};
                \drawBlackPointPoint{7}{9};
                \drawBlackPointPoint{8}{9};
                \drawBlackPointPoint{9}{9};
                \drawBlackPointPoint{9}{10};
                \drawBlackPointPoint{10}{10};
                \drawBlackPointPoint{10}{11};

            \end{tikzpicture} &
            \begin{tikzpicture}[scale=0.4]
                \draw[step=0.5,white,thin,xshift=-1cm,yshift=-1cm] (-0.75,-0.75) grid (6.25,8.25);
            \end{tikzpicture}
        \end{tabular}
    \end{frame}
    \begin{frame}{Computing the visibility}
        \begin{tabular}{c c}
            \begin{tikzpicture}[scale=0.4]
                ...
                \draw[MyGreen, dashed, very thick] (7,9)--(11,3);
                \drawPoint{7}{9};
                \drawPoint{11}{3};
            \end{tikzpicture} &
            \begin{tikzpicture}[scale=0.4]
    ...
    \begin{frame}{Computing the visibility}
        \begin{tabular}{c c c}
            \begin{tikzpicture}[scale=0.4]
                ...
                \drawInterval{3.5}{-0.5}{7.5}{blue};
                \drawInterval{3.5}{0}{7.5}{blue};
                \drawInterval{-0.5}{0.5}{10.5}{blue};
                \drawInterval{-0.5}{1}{4.5}{blue};
                \drawInterval{6.5}{1}{10.5}{blue};
                \drawInterval{-0.5}{1.5}{4.5}{blue};
                \drawInterval{6.5}{1.5}{11.5}{blue};
                \drawInterval{9.5}{2}{11.5}{blue};
                \drawInterval{9.5}{2.5}{11.5}{blue};
                \drawInterval{10.5}{3}{11.5}{blue};
                \drawInterval{10.5}{3.5}{11.5}{blue};
                \drawInterval{10.5}{4}{11.5}{blue};
                \drawInterval{9.5}{4.5}{11.5}{blue};
                \drawInterval{9.5}{5}{11.5}{blue};
                \drawInterval{8.5}{5.5}{11.5}{blue};
                \drawInterval{8.5}{6}{10.5}{blue};
                \drawInterval{6.5}{6.5}{10.5}{blue};
                \drawInterval{6.5}{7}{9.5}{blue};
                \drawInterval{6.5}{7.5}{9.5}{blue};
                \drawInterval{6.5}{8}{7.5}{blue};
                \drawInterval{6.5}{8.5}{9.5}{blue};
                \drawInterval{6.5}{9}{9.5}{blue};
                \drawInterval{6.5}{9.5}{10.5}{blue};
                \drawInterval{8.5}{10}{10.5}{blue};
                \drawInterval{8.5}{10.5}{10.5}{blue};
                \drawInterval{9.5}{11}{10.5}{blue};
                \drawInterval{9.5}{11.5}{10.5}{blue};

            \end{tikzpicture} & \raisebox{0.3\textheight}{<--} &
            \begin{tikzpicture}[scale=0.4]
                \draw[step=0.5,lightgray,thin,xshift=-1cm,yshift=-1cm] (-0.75,-0.75) grid (6.25,8.25);
                \draw[MyGreen, dashed, very thick] (0,6)--(4,0);
                \drawInterval{-0.5}{6.5}{0.5}{red};
                \drawInterval{-0.5}{6}{0.5}{red};
                \drawInterval{-0.5}{5.5}{0.5}{red};
                \drawInterval{0.5}{5}{0.5}{red};
                \drawInterval{0.5}{4.5}{1.5}{red};
                \drawInterval{1.5}{4}{1.5}{red};
                \drawInterval{1.5}{3.5}{2.5}{red};
                \drawInterval{1.5}{3}{2.5}{red};
                \drawInterval{1.5}{2.5}{2.5}{red};
                \drawInterval{2.5}{2}{2.5}{red};
                \drawInterval{2.5}{1.5}{3.5}{red};
                \drawInterval{3.5}{1}{3.5}{red};
                \drawInterval{3.5}{0.5}{4.5}{red};
                \drawInterval{3.5}{0}{4.5}{red};
                \drawInterval{3.5}{-0.5}{4.5}{red};
                \drawBlackPointPoint{0}{6}
                \drawBlackPointPoint{4}{0}
            \end{tikzpicture}
        \end{tabular}
    \end{frame}
    \begin{frame}{Computing the visibility}
        ...
        \begin{tikzpicture}[scale=0.4]
            ...
            \newcommand{\drawIntervalShifted}[3]{
                \draw[thick,red, arrows = {Bracket[sharp]-Bracket[sharp]}] (#1-0.1+7,#2+3)--(#3+0.1+7,#2+3);
            }
            \drawIntervalShifted{-0.5}{6.5}{0.5};
            \drawIntervalShifted{-0.5}{6}{0.5};
            \drawIntervalShifted{-0.5}{5.5}{0.5};
            \drawIntervalShifted{0.5}{5}{0.5};
            \drawIntervalShifted{0.5}{4.5}{1.5};
            \drawIntervalShifted{1.5}{4}{1.5};
            \drawIntervalShifted{1.5}{3.5}{2.5};
            \drawIntervalShifted{1.5}{3}{2.5};
            \drawIntervalShifted{1.5}{2.5}{2.5};
            \drawIntervalShifted{2.5}{2}{2.5};
            \drawIntervalShifted{2.5}{1.5}{3.5};
            \drawIntervalShifted{3.5}{1}{3.5};
            \drawIntervalShifted{3.5}{0.5}{4.5};
            \drawIntervalShifted{3.5}{0}{4.5};
            \drawIntervalShifted{3.5}{-0.5}{4.5};
            \drawPoint{0+7}{6+3}
            \drawPoint{4+7}{0+3}
    ...
    \begin{frame}{Computing the visibility}
        \begin{itemize}
            \item \textcolor{red}{$\times$ Pair p q -> Is $pq \in X$ -> p and q are visible}
            \item \textcolor{green}{$\sqrt$ Visibility segment v -> At which positions p does $v \in X$ -> p and p+v are visible}
            \begin{itemize}
                \item[$\rightarrow$] Paradigm change
            \end{itemize}
        \end{itemize}
    \end{frame}
...
%                    Xies 5
    ...
    \begin{frame}{Computing visibility : advantages}
        \begin{tikzpicture}
            ...
            \begin{axis}[
                ...
                \addlegendentry{$\Theta \left(m \sqrt{m}\right)$}
    ...
    \begin{frame}{Normal estimation demo}
        ...
        \begin{tikzpicture}[scale=0.5]
            ...
            \dpn{7.161978151947899}{3.6128706307461473}{MyGreen} node[anchor=north west] {$c_p$};

            \newcommand{\drawArrow}[3]{
            % Draws an arrow from point (x1,y1) to point c_p with weight w
                \draw[red,line opacity=#3,line width=#3, arrows=-Stealth] (#1,#2)--(7.161978151947899,3.6128706307461473);
            }

            \drawArrow{2}{0}{0.10251175769346066}
            \drawArrow{3}{0}{0.169013315406066}
            \drawArrow{4}{0}{0.24935220877729622}
            \drawArrow{4}{1}{0.3678794411714424}
            \drawArrow{5}{1}{0.4856717852477124}
            \drawArrow{5}{2}{0.6411803884299545}
            \drawArrow{5}{3}{0.7574651283969663}
            \drawArrow{6}{3}{0.8948393168143698}
            \drawArrow{6}{4}{0.9459594689067654}
            \drawArrow{8}{4}{0.9459594689067654}
            \drawArrow{8}{5}{0.8948393168143698}
            \drawArrow{9}{5}{0.7574651283969663}
            \drawArrow{10}{5}{0.5737534207374327}
            \drawArrow{11}{5}{0.3888955639892229}
            \drawArrow{11}{6}{0.3291929878079055}
            \drawArrow{12}{6}{0.1996656400679019}
            \drawArrow{13}{6}{0.10836802322189582}
            \drawArrow{13}{7}{0.08208499862389876}
