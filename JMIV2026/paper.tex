...
\abstract{Computing visibility on a geometric object requires heavy
...
\begin{document}
%
    \title[Fast and exact visibility on digitized shapes and application to saliency-aware normal estimation]{Fast and exact visibility on digitized shapes and application to saliency-aware normal estimation}
    \author*[1]{\fnm{Romain} \sur{Negro}}\email{romain.negro@univ-smb.fr}
