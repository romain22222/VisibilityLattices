...
%
    ...
    \author[1]{\fnm{Jacques-Olivier} \sur{Lachaud}}\email{jacques-olivier.lachaud@univ-smb.fr}

    \affil[1]{\orgdiv{LAMA}, \orgname{Université Savoie Mont Blanc, CNRS}, \orgaddress{\city{Chambéry}, \postcode{73000}, \country{France}}}
