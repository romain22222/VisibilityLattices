...
and the Mitra estimator~\cite{mitra:2003-acm}.
...
\begin{figure*}
    ...
    \begin{tabular}{|c||c|c|c|}
        ...
        Cps      &    &       &      \\
        \hline
        \raisebox{6mm}{With cube edges} &
        \formatImageFigNormalesShow{cps-IIN-flat-edge} &
        \formatImageFigNormalesShow{cps-Mitra-flat-edge} &
        \formatImageFigNormalesShow{cps-VN-flat-edge} \\
        \hline
        \raisebox{6mm}{Flat (no shading)} &
        ...
        \hline
        \raisebox{6mm}{With cube edges} &
        \formatImageFigNormalesShow{filigree-IIN-flat-edge} &
        \formatImageFigNormalesShow{filigree-Mitra-flat-edge} &
        \formatImageFigNormalesShow{filigree-VN-flat-edge} \\
        \hline
        \raisebox{6mm}{Flat (no shading)} &
    ...
    uses the Mitra algorithm, and last set uses our visibility algorithm
    ...
    Invariant normals'' are computed using a radius of $r=4.5$, Mitra with
...
\begin{figure*}
    \begin{center}
        \resizebox{!}{0.3\textheight}{%
            \begin{tabular}{|c||c|c|c|c|}
                \hline
                \backslashbox{}{} & II & CTriv & Mitra & Ours \\ \hline \hline
    ...
    by ``Convolved Trivial normals'' (radius $k=6$), third by ``Mitra Normals`` (radius $r=4$),fourth
