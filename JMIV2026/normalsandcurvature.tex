...
we ignore the points that are closer than $4h$ to the singularities for cubesphere and $8h$ for the ellipsoid union (see~\ref{fig:singularities-showcase}).
We see that the RMSE and $E_{\max}$ are much better than both II and PCA, with a convergence rate at $h^{\frac{2}{3}}$,
both failing to scale properly to accomodate the saillency. It however doesn't seem
