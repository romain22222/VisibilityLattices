...
\begin{figure*}
    ...
    The error is colored from white ($0rad$) to deep red ($0.1rad \approx 5.73\textdegree$). II normals are computed using a radius of
    $r=4.5$, PCA with a discrete radius of $\sigma = 3.5h\frac{1}{2}$, while our
