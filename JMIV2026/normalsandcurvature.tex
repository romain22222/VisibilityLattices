        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[
                    ...
                    domain=0.12:0.4,
                    samples=200,
                ] {0.1*x^(0.66)} node[pos=0.4, anchor=south west, yshift=10pt] {$h^{\frac{2}{3}}$};
            \end{axis}
        \end{tikzpicture} \\
        \begin{tikzpicture}
            \begin{axis}
                ...
                \addplot[
                    ...
                    domain=0.12:0.4,
                    samples=200,
                ] {0.1*x^(0.5)} node[pos=0.01, anchor=north east] {$h^{\frac{1}{2}}$};
            \end{axis}
        \end{tikzpicture} \\
        \begin{tikzpicture}
            \begin{axis}[
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[
                ...
                domain=0.12:0.4,
                samples=200,
            ] {2*x^(3)} node[pos=0.5, anchor=north east] {$h^{3}$};
        \end{axis}
    \end{tikzpicture}
    \begin{tikzpicture}
        \begin{axis}
