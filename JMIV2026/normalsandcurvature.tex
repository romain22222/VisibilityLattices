...
its proximity. In~\ref{fig:kernel-showcase}, we see that the Uniform kernel makes a lot more errors than the other two,
...
\begin{figure}
    \centering
    \begin{tabular}{cc c}
        \includegraphics[width=0.25\columnwidth]{pictures/kernelShowcase/uniform} &
        \includegraphics[width=0.25\columnwidth]{pictures/kernelShowcase/gaussian} &
        \includegraphics[width=0.25\columnwidth]{pictures/kernelShowcase/ring} \\
        Uniform & Gaussian & Ring \\
    \end{tabular}
    \caption{Normal error of the visibility normals with different kernels. The range of the error between white and deep red is $\lbrack 0, 0.07 \rbrack$ }
    \label{fig:kernel-showcase}
\end{figure}
...
it really depends on what kind of shapes we are facing with
