...
shapes and one piecewise smooth shape for $\Starop_1$ and $\Starop_2$
(Figure~\ref{fig:meanvisibility-gridstep}). Both follow a law
proportional to $1/\sqrt{h}$, but $\Starop_2$ has a bigger constant.
