...
for other shapes, the average visibility is proportionnal to $h^{-2/3}$ for $\Starop_1$ but to $h^{-3/2}$ for $\Starop_2$. Above a
...
\begin{figure}
    ...
    \caption{\label{fig:meanvisibility-gridstep-piecewise} Mean distance of visibility as a function of the gridstep $h$ for 3 piecewise smooth shapes (see text).}
\end{figure}