...
visibility distance on 3 piecewise smooth shapes (Figure~\ref{fig:meanvisibility-gridstep-piecewise}).
It shows that the average visibility distance still decreases with the
gridstep, but proportionally to
% $h^{?}$ WIP
