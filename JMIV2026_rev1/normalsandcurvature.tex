...
Furthermore, its computational cost is significantly higher: it takes about 48m for the dragon shape alone, while
the other three methods combined (the 2 different radii for each method and the visibility computation included)
take about 1m. Our visibility normals are stable on smooth parts while capturing sharp features,
