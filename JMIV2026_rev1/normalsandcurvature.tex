...
starting from \replaced[author=ROM]{$k \geq 2$}{$k=2$}. However we did not see a significant influence on
...
we ignore the points that are closer than $4h$ to the singularities for Cubesphere and $8h$ for the GluedEllipsoid (see~\ref{fig:singularities-showcase}).
