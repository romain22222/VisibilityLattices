...
\begin{figure*}
    ...
    \begin{tabular}{|c||c|c|c|c|}
        ...
        \formatImageFigNormalesShow{cps-II-combined} &
        \formatImageFigNormalesShow{cps-PCA-combined} &
        \formatImageFigNormalesShow{cps-Adafit} &
        \formatImageFigNormalesShow{cps-VN} \\
        \hline
        \nameDisplayFigNormal{Dragon} &
        \formatImageFigNormalesShow{dragon-II-combined} &
        \formatImageFigNormalesShow{dragon-PCA-combined} &
        \formatImageFigNormalesShow{dragon-Adafit} &
        \formatImageFigNormalesShow{dragon-VN} \\
        \hline
        \nameDisplayFigNormal{Filigree} &
        \formatImageFigNormalesShow{filigree-II-combined} &
        \formatImageFigNormalesShow{filigree-PCA-combined} &
        \formatImageFigNormalesShow{filigree-Adafit} &
        \formatImageFigNormalesShow{filigree-VN} \\
        \hline
        \raisebox{9mm}{Tie Fighter} &
        \formatImageFigNormalesShow{tie-II-combined} &
        \formatImageFigNormalesShow{tie-PCA-combined} &
