    ...
    \replaced[author=ROM]{litterature}{literature}~\cite{ghosh:2007-book} and is still studied in higher
    ...
    in this form. Indeed, cells \replaced[author=ROM]{surounding}{surrounding} $X$ can be encoded as
    ...
    describes the specific data structure for encoding \replaced[author=ROM]{set}{sets} of grid
    cells, and the main algorithm that exploits this encoding to
    compute visibility exactly. Section~4 \replaced[author=ROM]{discrete}{presents our} normal estimator\replaced[author=ROM]{,and}{
    and explains} how it improves curvature estimates on digital
