    ...
    \replaced[id=ROM]{litterature}{literature}~\cite{ghosh:2007-book} and is still studied in higher
    ...
    in this form. Indeed, cells \replaced[id=ROM]{surounding}{surrounding} $X$ can be encoded as
    ...
    describes the specific data structure for encoding \replaced[id=ROM]{set}{sets} of grid
    cells, and the main algorithm that exploits this encoding to
    compute visibility exactly. Section~4 \replaced[id=ROM]{discrete}{presents our} normal estimator\replaced[id=ROM]{,and}{
