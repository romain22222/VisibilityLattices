...
points. \replaced[author=ROM]{Let}{Consider a point} $p \in K$. Then $\pi^{-1}_j( \pi_j(p)) \cap \Star{K}$ is a set of cells having
...
(i.e.\ the start and end of the \replaced[author=ROM]{1st}{first} interval are both smaller than the
